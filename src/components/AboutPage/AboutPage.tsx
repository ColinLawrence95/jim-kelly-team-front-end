...
function AboutPage() {
  return (
    ...
    >
      ...
      >
        <GuideBanner photoUrl="/about-team-image.png" />

        {/* Static image and paragraph */}
        <div className="about-team-image-and-desc">
                  
          <h1 className="about-team-header">Meet the team</h1>
        ...
        >
          <div className="about-element-container">
            ...
            <div className="about-desc">
              <p id="about-desc">
                With more than 35 years of real estate experience and a background as a professional
                engineer, Jim Kelly brings unmatched knowledge, precision, and strategy to every
                transaction. As the founder and leader of the team, he built the business with one
                mission in mind: to share his proven success and help others thrive. Jim is known
                for his sharp negotiation skills and calm, confident approach, even in the most
                complex deals. Originally from Dundee, Scotland, Jim came to Canada to build a
                better life for his family. His work is driven by the same values he lives by every
                day: dedication, resilience, and a tireless work ethic”
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="about-element-container">
            ...
            <div className="about-desc">
              <p>
                Sydney O’Prey is the newest member of The Jim Kelly Team, bringing a fresh
                perspective and a lifelong connection to real estate. As the granddaughter of Jim
                Kelly, she grew up learning the value of hard work and client care by watching him
                in action. A graduate of York University, Sydney combines academic knowledge with
                strong listening skills and a sincere passion for helping others. Before real
                estate, she spent eight years as a music educator, where she developed patience,
                empathy, and a people-first approach that now defines her work with clients. Sydney
                is dedicated to building lasting relationships and helping clients feel supported
